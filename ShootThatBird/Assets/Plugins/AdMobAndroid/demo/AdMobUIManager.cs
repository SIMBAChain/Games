...
public class AdMobUIManager : MonoBehaviourGUI
{
	...
	void OnGUI()
	{
		...
		if( GUILayout.Button( "Init" ) )
		{
			...
			AdMobAndroid.init( "a152fb90fd1aed8" );
		}
		...
		{
			// place it on the top
			AdMobAndroid.createBanner( AdMobAndroidAd.smartBanner, AdMobAdPlacement.TopCenter );
		}
		...
		if( GUILayout.Button( "Create 300x250 banner" ) )
		{
			...
			AdMobAndroid.createBanner( AdMobAndroidAd.tablet300x250, AdMobAdPlacement.TopCenter );
		}
